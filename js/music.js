$(document).ready(function () {
    ...
    if (param == "ff10") {
        ...
        $("#desc").append("<p>The Final Fantasy X soundtrack was released on August 1, 2001 by DigiCube and re-released on May 10, 2004 by Square Enix. This album spans 4 discs, 92 tracks and covers a complete duration of 272.43 minutes. It was composed, arranged and produced by Nobuo Uematsu. It is regarded as “absolutely amazing” by reviewers, with especially high regard for the track “To Zanarkand”.</p>");
    ...
    if (param == "ff9") {
        ...
        $("#desc").append("<p>The Final Fantasy IX soundtrack was released on August 30, 2000 by DigiCube and re-released on May 10, 2004 by Square Enix. This album spans 4 discs, 110 tracks and 286.5 minutes. It was composed, arranged and produced by Nobuo Uematsu. This album is regarded by reviewers as “a blessing for Final Fantasy music” and is best known for its soundtrack “Melodies of Life”, which is the game's theme song.</p>");
    ...
    if (param == "ff8") {
        ...
        $("#desc").append("<p>The Final Fantasy VIII soundtrack was released on March 10, 1999 by DigiCube and re-released May 10, 2004 by Square Enix. This album spans 4 discs, 74 tracks and covers a complete duration of 249 minutes.  Composed and produced by Nobuo Uematsu. This album is best known for the two tracks “Eyes on Me” which is the game's theme song and “Liberi Fatali” which is played during the games introduction. Music critics have reviewed the album as “one of the most memorable scores that you will ever hear”.</p>");
    ...
    if (param == "ff6") {
        ...
        $("#desc").append("<p>The Final Fantasy VI soundtrack was released on March 25, 1994 by DigiCube and re-released October 1, 2004 by Square Enix. This album spans 3 discs, 61 tracks and covers a complete duration of 187.76 minutes. It was composed by Nobuo Uematsu. This album is best known for the track “Dancing Mad”, which is regarded as some of the “most asounding music ever created on a keyboard”. Music critics have reviewed the album saying that “almost every track here is truly a very good or even great composition”.</p>");
